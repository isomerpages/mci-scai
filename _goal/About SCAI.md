...
<div class="row" style="background-color: #f3f3f3;padding: 15px 0px 0px 20px">
      <div class="column" style="padding: 10px 0px 0px 0px;"><img src="/images/People/ruimin_03.jpeg" alt="Ruimin"></div>
...
<div class="row" style="background-color: #f3f3f3;padding: 15px 0px 0px 20px">
      <div class="column" style="padding: 10px 0px 30px 0px;"><img src="/images/People/wanyi_03.jpeg" alt="Wanyi"></div>
      <div class="column" style="width: 80%; padding: 10px 20px 30px 20px;">
...
<div class="row" style="background-color: #f3f3f3;padding: 15px 0px 0px 0px">
      <div class="column" style="padding: 10px 0px 30px 20px;"><img src="/images/People/brenden_03.jpeg" alt="Dr Brendan Fong"></div>
      <div class="column" style="width: 80%; padding: 10px 20px 30px 20px;">
...
Here is the [foreword on SCAI](/about/foreword/) by Singapore's Minister for Communications and Information, and Minister-in-charge of Smart Nation and Cybersecurity, Josephine Teo, offering insights into our vision and aspirations for this conference.